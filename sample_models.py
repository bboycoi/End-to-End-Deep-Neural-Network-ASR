...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    simp_rnn0 = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn0')(input_data)
    # Add batch normalization 
    bn_rnn0 = BatchNormalization(name='bn_rnn0')(simp_rnn0)
    # Add recurrent 2nd layer with batch normalization
    simp_rnn1 = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn1')(bn_rnn0)
    # Add batch normalization 
